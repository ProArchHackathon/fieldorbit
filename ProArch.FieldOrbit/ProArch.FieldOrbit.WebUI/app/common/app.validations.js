...
var app_validationService_1 = require("./app.validationService");
        ...
        get: function () {
            for (var propertyName in this.control.errors) {
                if (this.control.errors.hasOwnProperty(propertyName) && this.control.touched) {
                    return app_validationService_1.ValidationService.getValidatorErrorMessage(propertyName, this.control.errors[propertyName]);
                }
            }
            return null;
        },
...
ControlMessages = __decorate([
    core_1.Component({
        ...
        template: "<div *ngIf=\"error !== null\">{{error}}</div>"
    }),
